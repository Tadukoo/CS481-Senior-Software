...
public class SOPControllerTest {
	...
	public void testSearchByID() {
		...
		List<SOP> testList = sc.searchForSOPs(searchID, false, "", false, "", 0, 0, 0, -1, -1);
	...
	public void testSearchByName() {
		...
		List<SOP> testList = sc.searchForSOPs(0, false, searchName, false, "", 0, 0, 0, -1, -1);
	...
	public void testSearchByPriority() {
		int searchPrio = 7; 
		List<SOP> testList = sc.searchForSOPs(0, false, "", false, "", searchPrio, 0, 0, -1, -1);
	...
	public void testSearchByAuthor() {
		...
		List<SOP> testList = sc.searchForSOPs(0, false, "", false, "", 0, 0, searchAuthorID, -1, -1);
