			...
			<form class="form-horizontal" method="post">
					...
					<div class="form-group row">
						<div class="fieldset col-3">
							<input type="number" class="form-control" id="sopID" name="sopID"
								value="${sopID}" placeholder="SOP ID">
						</div>
						<div class="fieldset col-3">
					...
					<div class="form-group row">
						...
						<div class="fieldset col-3">
							<input type="number" class="form-control" id="version"
								name="version" value="${version}" placeholder="Version">
						</div>
						<div class="fieldset col-3">
							<input type="number" class="form-control" id="authorID"
								name="authorID" value="${authorID}" placeholder="Author ID">
						</div>
						<div class="fieldset col-3">
				...
				<div class="SUtablecontents">
					<c:forEach begin="${page*displaySize}"
						end="${((page+1)*displaySize) - 1}" items="${sops}" var="current">
						<div class="row">
							<div class="col-1 text-center">
								<p>
									<a href="edit_sop?sopID=${current.ID}">Edit</a>
							</div>
							<div class="col-2 text-center">
