...
<body>
	...
	<div class="fluid-container">
		<form class="form-horizontal" method="post" onsubmit="setCookie('Session_id',getCookie(JSESSIONID),2)">
		...
		<p class="note">
			Don't have an account? <a href="./create_account"> Create an Account </a>
		</p>
	</div>
</body>
</html>