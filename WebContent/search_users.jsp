		...
		<form class="form-horizontal" method="post">
				...
				<div class="form-group row">
					<div class="fieldset col-3">
						<input type="number" class="form-control" id="userID"
							name="userID" value="${userID}" placeholder="User ID">
					</div>
					<div class="fieldset col-3">
						<input type="number" class="form-control" id="employeeID"
							name="employeeID" value="${employeeID}" placeholder="Employee ID">
					</div>
					<div class="fieldset col-3">
				...
				<div class="form-group row">
					...
					<div class="fieldset col-3">
						<input type="number" class="form-control" id="positionID"
							name="positionID" value="${positionID}" placeholder="Position ID">
					</div>
					<div class="fieldset col-3">
			...
			<div class="SUtablecontents">
				<c:forEach begin="${page*displaySize}"
					end="${((page+1)*displaySize) - 1}" items="${users}" var="current">

					<div class="row">
						<div class="col-1 text-center">
							<p>
								<a href="edit_user?userID=${current.ID}">Edit</a>
						</div>
						<div class="col-2 text-center">
